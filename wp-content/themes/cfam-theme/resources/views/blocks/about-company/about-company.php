...
acf_register_block_type([
    'name'            => 'about-company',
    'title'           => __('About Company', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_about_company',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_about_company($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./about-company.twig'], $context);
}
