...
acf_register_block_type([
    'name'            => 'info-list',
    'title'           => __('Info List', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_info_list',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_info_list($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./info-list.twig'], $context);
}
