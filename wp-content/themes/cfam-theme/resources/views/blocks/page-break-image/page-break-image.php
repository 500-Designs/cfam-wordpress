...
acf_register_block_type([
    'name'            => 'page-break-image',
    'title'           => __('Page Break Image', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'    => 'block_render_callback_page_break_image',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
 ...
 */
function block_render_callback_page_break_image($block, $content = '', $is_preview = false)
{
    ...
    // Render the block.
    Timber::render(['./page-break-image.twig'], $context);
}