...
acf_register_block_type([
    'name'            => 'team-grid',
    'title'           => __('Team Grid', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_team_grid',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_team_grid($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./team-grid.twig'], $context);
}
