...
acf_register_block_type([
    ...
    'title'           => __('Section Wrapper', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_section_wrapper',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_section_wrapper($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./section-wrapper.twig'], $context);
}
