...
acf_register_block_type([
    'name'            => 'bar-charts',
    'title'           => __('Bar Charts', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback' => 'block_render_callback_bar_charts',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
    'keywords'        => ['charts', 'bar'],
...
*/
function block_render_callback_bar_charts($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./bar-charts.twig'], $context);
}
