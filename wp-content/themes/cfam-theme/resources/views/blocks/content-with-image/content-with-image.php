...
acf_register_block_type([
    ...
    'title'           => __('Content with Image', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_content_with_image',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_content_with_image($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./content-with-image.twig'], $context);
}
