...
acf_register_block_type([
    'name'            => 'cta-half',
    'title'           => __('CTA Half', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_cta_half',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_cta_half($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./cta-half.twig'], $context);
}
