...
acf_register_block_type([
    'name'            => 'counter',
    'title'           => __('Counter', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback' => 'block_render_callback_counter',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
    'keywords'        => ['counter', 'list'],
...
*/
function block_render_callback_counter($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./counter.twig'], $context);
}
