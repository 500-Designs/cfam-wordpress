...
acf_register_block_type([
    'name'            => 'text-grid',
    'title'           => __('Text Grid', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_text_grid',
    'category'        => 'layout',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_text_grid($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./text-grid.twig'], $context);
}
