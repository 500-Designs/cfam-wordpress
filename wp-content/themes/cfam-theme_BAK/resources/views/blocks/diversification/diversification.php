...
acf_register_block_type([
    ...
    'title'           => __('Diversification', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_diversification',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_diversification($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./diversification.twig'], $context);
}