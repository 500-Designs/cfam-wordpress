...
acf_register_block_type([
    'name'            => 'styled-header',
    'title'           => __('Styled Header', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_styled_header',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_styled_header($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./styled-header.twig'], $context);
}
