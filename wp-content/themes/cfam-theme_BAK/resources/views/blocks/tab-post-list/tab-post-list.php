...
acf_register_block_type([
    'name'            => 'tab-post-list',
    'title'           => __('Tab  Post List', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_tab_post_list',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_tab_post_list($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./tab-post-list.twig'], $context);
}
