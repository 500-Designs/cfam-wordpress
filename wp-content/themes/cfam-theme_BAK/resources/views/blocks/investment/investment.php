...
acf_register_block_type([
    'name'            => 'investment',
    'title'           => __('Investment', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_investment',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_investment($block, $content='', $is_preview = false) {
    ...
    Timber::render('./investment.twig', $context);
