...
acf_register_block_type([
    ...
    'title'           => __('Tax Information', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback' => 'block_render_callback_tax_information',
    'category'        => 'section',
    // 'icon'         => 'video-alt3',
    'keywords'        => ['tables', 'tax'],
...
*/
function block_render_callback_tax_information($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./tax-information.twig'], $context);
}
