...
acf_register_block_type([
    'name'            => 'info-with-image-2',
    'title'           => __('Info with Image 2', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback'	=> 'block_render_callback_info_with_image_2',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_info_with_image_2($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./info-with-image-2.twig'], $context);
}
