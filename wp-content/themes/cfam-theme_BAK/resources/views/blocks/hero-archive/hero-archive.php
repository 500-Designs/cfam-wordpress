...
acf_register_block_type([
    'name'            => 'hero-archive',
    'title'           => __('Hero Archive', 'lucera-bootstrap-backend'),
    'description'     => __('', 'lucera-bootstrap-backend'),
    'render_callback' => 'block_render_callback_hero_archive',
    'category'        => 'section',
    // 'icon'            => 'video-alt3',
...
*/
function block_render_callback_hero_archive($block, $content='', $is_preview = false) {
    ...
    // Render the block.
    Timber::render(['./hero-archive.twig'], $context);
}
